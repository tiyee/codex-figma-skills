...
| Skill | 用途 | 主要产物 |
| --- | --- | --- |
| [`snapshot-to-figma`](skills/snapshot-to-figma/README.zh-CN.md) | 从截图或视觉参考重建 Figma 页面/组件 | 语义化图层、Auto Layout、变量、组件与视觉对比结果 |
| [`figma-to-wxa-skyline`](skills/figma-to-wxa-skyline/README.zh-CN.md) | 将 Figma 设计实现到 Skyline 小程序 | 原生 WXML/WXSS/JS/TS、glass-easel 组件、资源、状态与验证结果 |
